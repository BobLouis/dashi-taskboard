  ...
  return (
    ...
    >
      ...
      >
        ...
        <label>
          <span>{text("使用者名稱 / Email", "Username / Email")}</span>
          <input
        ...
        <label>
          <span>{text("密碼 / API token", "Password / API token")}</span>
          <input
            required={!connection?.configured}
            type="password"
        ...
        <p>{text("Jira Cloud 請使用 Atlassian Email 和 API token。", "For Jira Cloud, use your Atlassian email and API token.")}</p>
